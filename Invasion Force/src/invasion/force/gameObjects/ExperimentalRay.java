...
/**
 * The Experimental Ray weapon which has 50% chance to damage the ship more than
...
public class ExperimentalRay
    ...
    /**
     * MODIFIES: This. EFFECTS: Creates an instance of an Experimental Ray;
    ...
    /**
     * EFFECTS: Calculates random 50/50 chance to damage the ship more than
     * enemies and vice versa; in the first case, the ship loses 50% of the
     * total power; in the second case, all the Jovians in the quadrant are
     * destroyed.
     */
