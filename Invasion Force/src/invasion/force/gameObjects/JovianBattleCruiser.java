...
public class JovianBattleCruiser
     ...
     * This. EFFECTS: Creates an instance of Jovian Battle Cruiser and puts it
     * into a sector; sets the cruiser's label and initial speed; passes the
     * ship as a target.
     *
     ...
     * the object is any weapon and object's bumped() called so that they can
     * deal with this particular impact; EFFECTS: Destroys the battle cruiser by
     * any weapon.
     *
    ...
    /**
     * PURPOSE: Nothing happens because this.move() doesn't allow to bump into
     * anything.
     *
     * @param object The object that collided with this.
     */
