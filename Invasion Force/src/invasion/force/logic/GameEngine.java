...
public class GameEngine {
    ...
    public void update() {
        ...
        for (int i = 0; i < quadObjects.size(); i++) {
            ...
            if (quadObjects.get(i) instanceof SpaceStation) {
                panels.grid[pos.getCol()][pos.getRow()].setForeground(Color.BLUE);
            }
            try {
        ...
        for (int i = 0; i < weaponObjects.size(); i++) {
            if (weaponObjects.get(i) instanceof Maser) {
                ...
                if (quadObjects.get(i) instanceof Maser) {
                    panels.grid[pos.getCol()][pos.getRow()].setForeground(Color.CYAN);
                }
